...
const Login = () => {
    ...
    return (
        <div className='w-screen h-screen relative'>
            ...
            {isForgotPassword && <div className='absolute animate-slide-right top-0 left-0 bottom-0 right-0 bg-white flex justify-center py-8 z-50 '>
                <div className='flex flex-col'>
                    <label for='email' htmlFor='email' className='text-[18px]'>Enter your email:</label>
                    <input 
                    type='text'
                    id='email'
            ...
            <div className='absolute top-0 bottom-0 left-0 right-1/2 items-center justify-center flex'>
                <div className='p-8 bg-white rounded-md min-w-[500px] flex flex-col items-center'>
                    <div className='flex w-full justify-center '>
                        <h1 className=' w-[90%]  text-[30px] font-semibold text-main mb-8 flex justify-center pl-8'>{isRegister ? 'REGISTER' : 'LOGIN'}</h1>
                        <Link 
                        to={`/${path.HOME}`}
                    ...
                    <div className='flex  items-center justify-between pt-5 w-full text-[16px]'>
                        {!isRegister && (
                            <span className='text-blue-600 hover:text-red-400 cursor-pointer'
                        ...
                        {isRegister && (
                            <span className='text-blue-600 hover:text-red-400 cursor-pointer w-full text-center' 
