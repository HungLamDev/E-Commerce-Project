...
const InputField = ({ value, setValue, nameKey, type, invalidFields, setInvalidField, style }) => {
    return (
        <div className='w-full relative flex flex-col gap-1 mb-2'>
            ...
            <input 
                ...
                className={clsx('px-4 py-2 rounded-sm border w-full mt-2 placeholder:text-sm placeholder:italic outline-none', style)} // Các lớp CSS để tạo kiểu cho trường nhập liệu
